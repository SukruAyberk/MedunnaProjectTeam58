...
public class US001 {
    ...
    ReusableMethods.waitFor(3);
    soft=new SoftAssert();
    soft.assertTrue(recepPage.successMessageToastContainer.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorInvalidSsnMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorBlankSsnMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorFirstNameMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorLastNameMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorBlankUsernameMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorBlankEmailMessage.isDisplayed());
    }
    ...
    soft=new SoftAssert();
    soft.assertTrue(recepPage.errorInvalidEmailMessage.isDisplayed());
    }
